...
public class LinkedListStreet implements Street{
    private Mode _mode;
    private final int _length;
    private LinkedList<AbstractBuilding> _frontSide, _backSide;

    public LinkedListStreet(){
        _frontSide = new LinkedList<AbstractBuilding>();
        _backSide = new LinkedList<AbstractBuilding>();
        _mode = Mode.Read_Only;
        _length = 20;
    }

    public LinkedListStreet(int length){
        _frontSide = new LinkedList<AbstractBuilding>();
        _backSide = new LinkedList<AbstractBuilding>();
        _mode = Mode.Read_Only;
        _length = length;
               ...
               ReadOnlyException
    {
        ...
        LinkedList<AbstractBuilding> targetside;
        if(side == Side.Front)
